...
namespace ic.backend.precotex.web.Data.Repositories.Implementation.Laboratorio
{
    public interface ILbColaTrabajoRepository
    {
        ...
        */
        ...
        Task<(int Codigo, string Mensaje)> ValidarCorridaDuplicadaAsync(string Corr_Carta, int Sec, int Correlativo, string Tip_Ten, string Usr_Cod, int Correlativo_Anterior);
