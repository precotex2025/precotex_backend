...
namespace ic.backend.precotex.web.Data.Repositories.Implementation.Cotizaciones
{
    public interface ITxCotizacionesRepository
    {
        ...
        Task<IEnumerable<Tx_Cotizaciones_Cab>?> ListaCabecerasCotizacion(int Pro_Cen_Cos, string Cod_Tipo, string Cod_Cliente_Tex, string Cod_Tela, string Cod_Ruta, string? Cod_Color, string? SDC_Referencia);
        Task<IEnumerable<Tx_Cotizaciones>?> ListaDetalleCotizacionXVersion(int IdCotizacion_Cab, int Num_Version);
        Task<IEnumerable<Tx_Cotizaciones>?> ListaDetalleCotizacionXFiltros(int Pro_Cen_Cos, string Cod_Tipo, string Cod_Cliente_Tex, string Cod_Tela, string Cod_Ruta, string? Cod_Color, string SDC_Referencia, decimal precio, int tiempo);
