...
namespace ic.backend.precotex.web.Data.Repositories.Implementation.Calidad
{
    public interface INoConformidadesRepository
    {
        ...
        Task<ResponseResultado> GuardarTransaccionCompleta(InformeGuardarRequest req);
