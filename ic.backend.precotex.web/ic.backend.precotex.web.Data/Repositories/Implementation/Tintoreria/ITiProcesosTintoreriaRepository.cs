...
namespace ic.backend.precotex.web.Data.Repositories.Implementation.Tintoreria
{
    public interface ITiProcesosTintoreriaRepository
    {
        ...
        Task<IEnumerable<Tx_Muestra_Control_Proceso>?> ListaControlProcesosTintoreria(string Cod_Ordtra, DateTime? Fecha_Ini, DateTime? Fecha_Fin, string Numero_Referencia);
