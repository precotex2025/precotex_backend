...
namespace ic.backend.precotex.web.Service.Services.Implementacion.Tintoreria
{
    public interface ITiProcesosTintoreriaService
    {
        ...
        Task<ServiceResponseList<Tx_Muestra_Control_Proceso>?> ListaControlProcesosTintoreria(string Cod_Ordtra, DateTime? Fecha_Ini, DateTime? Fecha_Fin, string Numero_Referencia);
