...
namespace ic.backend.precotex.web.Service.Services.Implementacion.Laboratorio
{
    public interface ILbColaTrabajoService
    {
        ...
        */
        ...
        Task<ServiceResponse<int>> ValidarCorridaDuplicadaAsync(string Corr_Carta, int Sec, int Correlativo, string Tip_Ten, string Usr_Cod, int Correlativo_Anterior);
