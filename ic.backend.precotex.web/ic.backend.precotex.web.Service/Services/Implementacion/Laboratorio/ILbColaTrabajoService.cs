    ...
    public interface ILbColaTrabajoService
    {
        ...
        */
        ...
        /*
            DETALLE 
        */
        Task<ServiceResponseList<Lb_ColTra_Det>?> ListaColoresSDC(string Corr_Carta);
        ...
        Task<ServiceResponseList<Lb_ColTra_Cab_y_Det>?> LlenarGrillaDesplegable(string Corr_Carta, int Sec);
        ...
        */
        ...
        Task<ServiceResponseList<Colorantes_Reporte>?> CargarDatosReporteTrico(string Corr_Carta, int Sec, string Tip_Ten);
        Task<ServiceResponseList<Reporte_ph>?> CargarDatosReportePH(string Corr_Carta, int Sec, string Tip_Ten);
        /*
            COMPONENTES EXTRA   
        */
        ...
        */
        ...
        Task<ServiceResponseList<Lb_AgrOpc_Colorantes>?> ObtenerUltimoCorrelativo(string Corr_Carta, int Sec);
        Task<ServiceResponse<int>> AgregarOpcionAjustada(Lb_AgrOpc_Colorantes valores);
        ...
        Task<ServiceResponse<int>> ValidarCorridaDuplicadaAsync(string Corr_Carta, int Sec, int Correlativo, string Tip_Receta, string Usr_Cod, int Correlativo_Anterior);
        Task<ServiceResponse<int>> EntregarCorridaAsync(string Corr_Carta, int Sec, int Correlativo, string Procedencia, string Tip_Ten, string Usr_Cod);
